...
| [Audit - Compliance Report Generator](AUDIT---Report-Generator.user.js) | Multi-page audit console: Work Orders, POs, Library, Tools, Inventory. Date range, category filters, PDF export. |
